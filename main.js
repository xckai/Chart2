define(["require", "exports", "Chart/Flexable", "Chart/Service", "lib/d3"], function (require, exports, Flexable_1, Service_1, d3) {
    "use strict";
    ...
    Flexable_1.Flexable.connectContainerAndScrollbar(scroll, 5, 200, 900, 0, function (obj) {
    ...
    Flexable_1.Flexable.connectContainerAndScrollbar(scroll1, 5, 200, 900, 0, function (obj) {
    ...
    var texts2 = svg2.selectAll("text").data(d3.range(30))
        ...
        .attr("dominant-baseline", "text-before-edge")
        .text(function (d) { return d; });
    Flexable_1.Flexable.flexableContainer(200, 200, 20, 900, 900, svg2);
});
