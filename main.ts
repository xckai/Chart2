import {connectContainerAndScrollbar,flexableContainer} from "Chart/Flexable"
import {Service} from "Chart/Service"
import d3= require("lib/d3"); 
import underscore=require("lib/underscore");
...
let translateStr=Service.stringTemplate("translate({x},{y})")
    ...
    connectContainerAndScrollbar(scroll,5,200,900,0,function(obj){
    ...
    connectContainerAndScrollbar(scroll1,5,200,900,0,function(obj){
    ...
    var texts2= svg2.selectAll("text").data(d3.range(30))
                        ...
                        .attr("dominant-baseline", "text-before-edge")
                        .text((d)=>d);
   flexableContainer(200,200,20,900,900,svg2);   
