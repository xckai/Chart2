...
var KPIPanal = (function () {
    function KPIPanal() {
        // _chart=comparechart.ChartManager.createCompareChart({
        //         "width": 400,
        //         "height": 230,
        //         title: "",
        //         xType: "TimeSeries",
    ...
    KPIPanal.prototype.render = function () {
        ...
        if (!this._node) {
            ...
            t1 = div_1.append("xhtml:div").classed("t1 kpi ", true);
            t1.append("xhtml:button").text(this._config.label0 || "KPI-1").classed("active", true)
                .on("click", function () {
                div_1.selectAll("button").classed("active", false);
                t1.select("button").classed("active", true);
                charts.selectAll(".chart").style("display", "none");
                c1.style("display", "block");
            });
            t1.append("xhtml:text").classed("value", true);
            t2 = div_1.append('xhtml:div').classed("t2 kpi", true);
            t2.append("xhtml:button").text(this._config.label1 || "KPI-2").on("click", function () {
                div_1.selectAll("button").classed("active", false);
                t2.select("button").classed("active", true);
                charts.selectAll(".chart").style("display", "none");
                c2.style("display", "block");
            });
            t2.append("xhtml:text").classed("value", true);
            t3 = div_1.append('xhtml:div').classed("t3 kpi", true);
            t3.append("xhtml:button").text(this._config.label2 || "KPI-3").on("click", function () {
                div_1.selectAll("button").classed("active", false);
                t3.select("button").classed("active", true);
                charts.selectAll(".chart").style("display", "none");
            ...
            c1 = charts.append("xhtml:div").classed("chart", true).style("display", "block").text(1);
            c2 = charts.append("xhtml:div").classed("chart", true).style("display", "none").text(2);
            c3 = charts.append("xhtml:div").classed("chart", true).style("display", "none").text(3);
    ...
    KPIPanal.prototype.update = function (d) {
        ...
        t1.transition().duration(1000).tween("text", function () {
            var num = d3_interpolate_1.interpolateNumber(+t1.text(), d.t1 || 0);
        ...
        t2.transition().duration(1000).tween("text", function () {
            var num = d3_interpolate_1.interpolateNumber(+t2.text(), d.t2 || 0);
        ...
        t3.transition().duration(1000).tween("text", function () {
            var num = d3_interpolate_1.interpolateNumber(+t3.text(), d.t3 || 0);
...
window.KPIPanal = KPIPanal;
//# sourceMappingURL=KPIPanal.js.map
}).call(this,require("qC859L"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_b2b3c122.js","/")
},{"../lib/d3":2,"buffer":4,"d3-interpolate":6,"qC859L":9}],2:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";
function __export(m) {
...
__export(require("d3-interpolate"));
//# sourceMappingURL=d3.js.map
}).call(this,require("qC859L"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/..\\lib\\d3.js","/..\\lib")
},{"buffer":4,"d3-interpolate":6,"d3-selection":7,"qC859L":9}],3:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"buffer":4,"qC859L":9}],4:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
...
},{"base64-js":3,"buffer":4,"ieee754":8,"qC859L":9}],5:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
}).call(this,require("qC859L"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/..\\node_modules\\d3-color\\build\\d3-color.js","/..\\node_modules\\d3-color\\build")
},{"buffer":4,"qC859L":9}],6:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
}).call(this,require("qC859L"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/..\\node_modules\\d3-interpolate\\build\\d3-interpolate.js","/..\\node_modules\\d3-interpolate\\build")
},{"buffer":4,"d3-color":5,"qC859L":9}],7:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
}).call(this,require("qC859L"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/..\\node_modules\\d3-selection\\build\\d3-selection.js","/..\\node_modules\\d3-selection\\build")
},{"buffer":4,"qC859L":9}],8:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"buffer":4,"qC859L":9}],9:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
